package com.marpol.score.service;
 ...
 * Service 클래스는 역활이 주로 비즈니스로직 코드가 작성된다.
...
public class ScoreServiceV1 {
	...
	public void scoreRndMake() {
		for(int i = 0 ; i < scoreList.length ; i++) {
			...
			// 23*** 형식의 학번 생성하기
			scoreList[i].stNum = String.format("23%03d", i +1);
	...
	public void scoreListPrint() {
		...
		System.out.println("한율 고교 성적처리 시스템 2023");
		System.out.println("-".repeat(70));

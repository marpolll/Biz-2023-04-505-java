...
public class StudentExecE {
	...
	public static void main(String[] args) {
		...
		String studentFile = "src/student.txt";
		
		/*
		 * java 에서 구현한 기본 OutputStream 에는 System.out; 있다.
		 ...
		 * cosole, File 또는 네트워크 등을 통하여 데이터를 보낼수 있다.
		 * 
		 */
		 ...
		 * PrintWriter.close() method 가 실행되기 전에는

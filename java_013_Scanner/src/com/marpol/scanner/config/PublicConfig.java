package com.marpol.scanner.config;

public class PublicConfig {
	
	/*
	 * 변수 선언문에 static 추가된 경우
	 * "클래스 변수"
	...
	/*
	 * 클래스에 포함된 변수, method 에는 static 키워드를 추가 할수 있다.
	 * 원래는 이러한 변수, method 를 정적변수, 정적method 라고 한다.
	 * 
	 * 프로젝트가 시작될때 언제든지 사용할수 있도록 미리 준비되는 도구들
	 * 사용할때는 `클래스명 변수`, `클래스명.method()` 와 같이 직접
	 * 클래스 이름을 통하여 접근한다.
	 */

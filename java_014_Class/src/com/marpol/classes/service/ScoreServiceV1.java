...
public class ScoreServiceV1 {
	...
	/*
	 * 매개변수로 일반 변수가 아닌 참조형 객체 변수를 사용했다. 참조형 객체변수는 실제 저장된 값이 전달되는게 아니고 기억장소의 주소가
	 * 전달된다.
	 * 
	...
	public void makeScore(List<ScoreDto> scoreList) {
		...
		for (int i = 0; i < classSize; i++) {
			...
			/*
			 * 배열에서는 먼저 배열선언, 배열초기화, 각 요소에 데이터 자장 List type 의 데이터 1. 먼저 비어있는(blank) List
			 * type 을 생성 2. Dto 객체변수를 생성하고 3. Dto 각 변수에 값을 setting(setter) 4. List 에 Dto를
			 * add
			 */

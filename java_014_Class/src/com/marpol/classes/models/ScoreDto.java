 ...
 * 3. 변수 값을 확인하기 위한 toString() method 를 제 정의
 */
public class ScoreDto {
	...
	/*
	 * Java 의 모든 클래스는 기본적으로 toString() method 를 포함하고 있다. 하지만 기본 toString() 은 메모리 주소를
	 * 보여주는 코드가 포함
	 * 
	 * Dto 클래스에서는 변수의 값들을 문자열로 변환하여 return 하는 method 로 제정의(다시선언) 한다.
	 * 
	 * @ : @ 이는 Annotation 키워드
	 * 
	 * @Override : 기존에 존재하는 method를 다시 선언 하겠다 라는 지시어
	 */
	@Override

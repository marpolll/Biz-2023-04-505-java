...
import com.marpol.classes.service.ScoreServiceV1;
...
public class ExecA {
	...
	public static void main(String[] args) {
		...
		// method 사용하기
		// 정의된(작성된) method 에게 어떤일을(업무,행위,메시지) 시키기
		// 
		...
		// scoreList 라는 데이터가 담긴 객체 변수의 `기억장치 주소`를
		...
		// return 된 결과를 result 변수에 저장해 달라 라는 요청

 ...
 * 
 * base-package : com.marpol.Classes
 * 3단위, 3단계 package 단위를 base-packge 라고 한다.
 * base-package 는 일부 Application ID (식별자) 역활을 한다. 
 * 
 */
...
public class ExecA {
	...
	public static void main(String[] args) {
		 ...
		 * 소수인가를 판별하고 그결과를 cosole 에 출력하기
		 */
		
		int result = prime(11);
		if(result > 0) {
			System.out.println(result + " 은(는) 소수");
		}
	}
